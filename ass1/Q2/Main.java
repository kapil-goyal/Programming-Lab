...
class Buffer {
    ...
    public Bottle getNewBottle() {
        //acquire lock so that multiple do not remove at the same time
        bottleLock.lock();
...
class Main {
                                    ...
                                    Sealing sealingUnit) 
    {
        ...
        if (packagingUnit.currentBottle != null) {
            //check type and status of bottle currently undergoing packaging and update corrsponding counts
        ...
        if (sealingUnit.currentBottle != null) {
            //check bottle type and state of the bottle currently in sealing unit and update corresponding counts
    ...
    public static void main (String[] args) throws InterruptedException {
        ...
        //initialise the variables storing current time and time to restart packaging and sealing threads
        ...
        //loop while either bottles are processing or time for observation is not reached
